(function (global, factory) {
	...
	(factory((global.angular2Modal = global.angular2Modal || {}),global.ng.core,global.Rx,global.Rx.Observable.prototype,global.ng.common,global.ng.platformBrowser));
...
var ModalOverlay = (function (_super) {
    ...
    ModalOverlay.prototype.embedComponent = function (config) {
        var /** @type {?} */ ctx = (config);
        if (ctx.bindings) {
            ctx.injector = _angular_core.ReflectiveInjector.fromResolvedProviders(ctx.bindings, this.vcr.parentInjector);
        }
...
var DOMOverlayRenderer = (function () {
    ...
    DOMOverlayRenderer.prototype.render = function (dialog, vcRef, injector) {
        ...
        var /** @type {?} */ bindings = _angular_core.ReflectiveInjector.resolve([
...
var Modal = (function () {
    ...
    Modal.prototype.createBackdrop = function (dialogRef, BackdropComponent) {
        var /** @type {?} */ b = _angular_core.ReflectiveInjector.resolve([{ provide: DialogRef, useValue: dialogRef }]);
...
//# sourceMappingURL=angular2-modal.rollup.umd.js.map
