...
import { DONATION_STATUSES } from '../interfaces/donation/donation';
...
export class Validation {
  ...
  public static readonly ACCOUNT_TYPE_REGEX = new RegExp(`^${ACCOUNT_TYPES.join('|')}$`);
  public static readonly DONATION_STATUS_REGEX = new RegExp(`^${DONATION_STATUSES.join('|')}$`);
