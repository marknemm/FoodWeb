...
import { AccountSelectConfig, AccountSelectDialogComponent } from '~web/account-shared/child-components/account-select-dialog/account-select-dialog.component';
