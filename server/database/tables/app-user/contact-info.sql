...
ALTER TABLE ContactInfo ADD COLUMN IF NOT EXISTS addressLatitude    NUMERIC(9, 6)   NOT NULL;
ALTER TABLE ContactInfo ADD COLUMN IF NOT EXISTS addressLongitude   NUMERIC(9, 6)   NOT NULL;
