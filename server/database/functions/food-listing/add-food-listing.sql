...
(
    ...
    _totalUnitsCount    INTEGER         DEFAULT 1,      -- The total number of available parts/units that the Food Listing is split up into.
...
BEGIN
    ...
    VALUES (
        ...
        _totalUnitsCount, _totalUnitsCount, _totalUnitsCount, _foodDescription, _imgURL
    )
