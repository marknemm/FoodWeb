...
export class appDataEntity1572400203132 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TYPE "audit_eventtype_enum" AS ENUM('Signup', 'Verify Account', 'Remove Unverified Account', 'Update Account', 'Update Password', 'Reset Password', 'Donate', 'Update Donation', 'Remove Donation', 'Claim Donation', 'Unclaim Donation', 'Schedule Delivery', 'Delivery State Advance', 'Delivery State Undo')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`CREATE TYPE "audit_eventtype_enum_old" AS ENUM('Signup', 'Verify Account', 'Remove Unverified Account', 'Update Account', 'Reset Password', 'Donate', 'Update Donation', 'Remove Donation', 'Claim Donation', 'Unclaim Donation', 'Schedule Delivery', 'Delivery State Advance', 'Delivery State Undo')`);
