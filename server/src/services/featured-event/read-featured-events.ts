...
import { QueryResult, genSkip, genTake } from '../../helpers/database/query-builder-helper';
 ...
 */
export function readAllFeaturedEventIdentifiers(): Promise<Partial<FeaturedEventEntity>[]> {
